...
export default function Ppf3DPage() {
  ...
  return (
    <main className="relative h-[100svh] min-h-[620px] overflow-hidden bg-[#020706] text-white">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_68%_56%,rgba(139,92,246,0.10),transparent_28%),radial-gradient(circle_at_18%_22%,rgba(16,185,129,0.10),transparent_25%)]" />
      <div className="mgx-demo2-fade pointer-events-none absolute inset-0 z-30 bg-[#030807]" />
      ...
      <style jsx>{`
        .mgx-demo2-fade {
          animation: mgxDemo2Fade 1.15s cubic-bezier(0.22, 1, 0.36, 1) forwards;
        }

        @keyframes mgxDemo2Fade {
          0% {
            opacity: 1;
          }
          35% {
