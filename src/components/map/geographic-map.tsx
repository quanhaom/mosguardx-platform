              ...
              >
                <Tooltip direction="top" offset={[0, -8]} opacity={1}>
                  <div className="min-w-[170px]">
                    ...
                    <div className="mt-1 text-[11px] text-slate-500">
                      {station.temperature == null ? "--" : `${station.temperature.toFixed(1)} °C`} · {station.humidity == null ? "--" : `${station.humidity.toFixed(1)}% RH`}
                    </div>
                  </div>
                </Tooltip>
                ...
                <Popup>
                  <div className="min-w-[190px]">
                    ...
                    <div className="mt-1 text-[11px] text-slate-500">
                      Nhiệt độ {station.temperature == null ? "--" : `${station.temperature.toFixed(1)} °C`} · Độ ẩm {station.humidity == null ? "--" : `${station.humidity.toFixed(1)}%`}
                    </div>
                  </div>
                </Popup>
              </CircleMarker>
